...
# -*- coding: utf-8 -*-
"""
同步 Top 2 到东方财富组合 20260920ZZ
9/20 周日非交易日, 复用 9/18 (周五) 报告 — Top 2 与 9/19 一致 (八方股份 + 融捷股份)
9/20 修正映射后, 2 只落入 energy 100% 胜率板块 (与 9/18-9/19 持平)
实际同步: 603489 八方股份 (电机-电踏车/锂电池) + 002192 融捷股份 (锂矿-修正映射)
"""
import sys
import os
import json
...
# Top 2 by 6 维评分 (复用 9/18 周五报告):
#   八方股份 (电机, energy 100% 胜率, 综合分 62.50)
#   融捷股份 (锂矿-修正映射, energy 100% 胜率, 综合分 44.56)
TOP_N = ["603489", "002192"]
...
def main():
    ...
    groups[PORTFOLIO_NAME] = {
        ...
        "report": "2026-09-18-选股报告.md",
        "deep_analysis": "2026-09-20-深度分析.md",
        "reuse_note": "9/20 周日非交易日, 复用 9/18 周五报告 (沿用 9/13+9/19 模式)",
