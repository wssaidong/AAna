...
# -*- coding: utf-8 -*-
"""
同步 Top 2 到东方财富组合 20260918ZZ
9/18 修正映射后, 2 只落入 energy 100% 胜率板块 (vs 9/17 仅 1 只), 50% 黑名单命中率
...
# Top 2 by 6 维评分: 八方股份 (电机, energy 100% 胜率, 综合分 62.50)
#                  + 融捷股份 (锂矿-修正映射, energy 100% 胜率, 综合分 42.56)
TOP_N = ["603489", "002192"]
...
def main():
    ...
    groups[PORTFOLIO_NAME] = {
        ...
        "deep_analysis": "2026-09-18-深度分析.md",
