...
# -*- coding: utf-8 -*-
"""
同步 Top 2 到东方财富组合 20260919ZZ
9/19 周六非交易日, 复用 9/18 (周五) 报告 — Top 2 与 9/18 一致 (八方股份 + 融捷股份)
9/19 修正映射后, 2 只落入 energy 100% 胜率板块 (与 9/18 持平)
...
def main():
    ...
    groups[PORTFOLIO_NAME] = {
        ...
        "deep_analysis": "2026-09-19-深度分析.md",
        "reuse_note": "9/19 周六非交易日, 复用 9/18 周五报告 (沿用 9/13 模式)",
