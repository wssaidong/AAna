...
# -*- coding: utf-8 -*-
"""
深度分析 2026-09-14 选股报告 (周一交易日, 9 只候选)
按照 9/11 + 9/12 + 9/13 深度分析报告 + 6 维评分 SOP 输出
含 9/13 修复: 水电 → energy (绿电大类 100% 胜率)
"""
import sys
import json
import os
...
TODAY = "2026-09-14"
RUN_ID = "01a09d52-6cdd-79bf-a836-8c94a20c9fc8"

# 9/14 候选池 (9 只, 与 9/11 相同 — 9/12 已确认)
CANDIDATES = [
    ...
    {"code": "600900", "name": "长江电力", "price": 28.45, "tech_score": 63, "composite": 57, "sector_hint": "水电"},  # 9/13 修复
...
def main():
    ...
    print(f"今日 {TODAY} 周一交易日 (autopilot 08:30 触发)")
